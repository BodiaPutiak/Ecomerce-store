...
const items = [
  ...
  },
  {
    ...
    specs:
      'Verner Panton Flowerpot, designed in 1968, was originally meant for the hospitality industry and Verner Panton displays and showrooms. The lamp then became popular in private homes, and due to its stylish design and many color choices, it has made a major comeback in recent years.',
    texture: 'Plastic',
    weight: '4kg',
    size: '15cm x 15cm',
  },
